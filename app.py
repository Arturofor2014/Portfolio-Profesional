...
# ══════════════════════════════════════════════════════════════════════════════
# CHATBOT FLOTANTE — JavaScript (siempre visible en todas las pestañas)
# ══════════════════════════════════════════════════════════════════════════════
...
<style>
  ...
  #chat-close { cursor: pointer; font-size: 18px; background: none; border: none; color: white; }
  #chat-messages {
    height: 280px; overflow-y: auto;
    padding: 12px; background: #F4F6FB;
  ...
  #chat-send:hover { background: #1E5FA8; }
</style>
...
<div id="chat-panel">
  ...
  <div id="chat-messages">
    <div class="cmsg-bot">¡Hola! Puedes preguntarme sobre experiencia, habilidades, proyectos o formación. ¿En qué te ayudo?</div>
  </div>
  <div id="chat-input-row">
    <input id="chat-input" type="text" placeholder="Escribe tu pregunta..." onkeydown="if(event.key==='Enter') sendMsg()"/>
...
const DEFAULT = "No tengo información sobre eso. Puedes preguntarme sobre: experiencia, habilidades, Python, Power BI, finanzas, dashboards, proyectos o educación.";
...
function sendMsg() {
  ...
  bDiv.innerText = getResponse(text);
